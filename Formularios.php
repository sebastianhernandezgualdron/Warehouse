        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            Formularios para registrar todo los datos necesarios para el inventario del almacén y sus tiendas.
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="card mb-4">
                                ...
                                <div class="card-footer small text-muted"><a href="./tables.php#DTClientes">Tabla de clientes</a></div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="card mb-4">
                                ...
                                <div class="card-footer small text-muted"><a href="./tables.php#DTProductos">Tabla de Productos</a></div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="card mb-4">
                                ...
                                <div class="card-footer small text-muted"><a href="./tables.php#DTProveedores">Tabla de Proveedores</a></div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="card mb-4">
                                ...
                                <div class="card-footer small text-muted"><a href="./tables.php#DTTiendas">Tabla de Tiendas</a></div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="card mb-4">
                                ...
                                <div class="card-footer small text-muted"><a href="./tables.php#DTCompras">Tabla de Compras</a></div>
                            </div>
                        </div>
                    </div>
                </div>
